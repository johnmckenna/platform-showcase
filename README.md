...
This repo showcases running applications inside ArgoCD with Crossplane instrumenting the local infrastructure.
...
* [nodejs@24](https://www.nixhub.io/packages/nodejs)
* [kind@latest](https://www.nixhub.io/packages/kind)
* [cloud-provider-kind@latest](https://www.nixhub.io/packages/cloud-provider-kind)
* [kubectl@latest](https://www.nixhub.io/packages/kubectl)
* [kubernetes-helm@latest](https://www.nixhub.io/packages/kubernetes-helm)
* [cilium-cli@latest](https://www.nixhub.io/packages/cilium-cli)
* [hubble@latest](https://www.nixhub.io/packages/hubble)
* [crossplane-cli@latest](https://www.nixhub.io/packages/crossplane-cli)
* [argocd@latest](https://www.nixhub.io/packages/argocd)
* [just@latest](https://www.nixhub.io/packages/just)
* [kubeconform@latest](https://www.nixhub.io/packages/kubeconform)
